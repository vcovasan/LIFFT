###########################################################################
## Makefile generated for Simulink model 'fftArduino'. 
## 
## Makefile     : fftArduino.mk
## Generated on : Tue Mar 31 22:37:09 2020
##  version:  
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fftArduino.elf
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fftArduino.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/shared/svd/include -I$(START_DIR)/fftArduino_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(ARDUINO_ROOT)/hardware/arduino/avr/cores/arduino -I$(ARDUINO_ROOT)/hardware/arduino/avr/variants/standard -I$(ARDUINO_ROOT)/libraries/Servo/src -I/Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/include -I/Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/scheduler/include -I/Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/include -I$(ARDUINO_ROOT)/hardware/tools/avr/avr/include/avr -I/Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/shared/externalmode_daemon/include
...
DEFINES_ = -DMODEL=fftArduino -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX -DCLASSIC_INTERFACE=0 -DALLOCATIONFCN=0 -DTID01EQ=0 -DONESTEPFCN=1 -DTERMFCN=1 -DMULTI_INSTANCE_CODE=0 -DINTEGER_CODE=0 -DMT=0 -DXCP_CUSTOM_PLATFORM -DEXIT_FAILURE=1 -DEXTMODE_DISABLEPRINTF -DEXTMODE_DISABLETESTING -DEXTMODE_DISABLE_ARGS_PROCESSING=1 -DSTACK_SIZE=64 -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DRT -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=100000 -DMW_ARDUINO_MICROS -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=fftArduino -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0 -DUNIX
...
%.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/fftArduino_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/fftArduino_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/fftArduino_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
MW_PWM.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/MW_PWM.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ArduinoPinHandleMap.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/ArduinoPinHandleMap.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


MW_AnalogInput.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/MW_AnalogInput.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/fftArduino_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fftArduino.o : $(START_DIR)/fftArduino_ert_rtw/fftArduino.c
	$(CC) $(CFLAGS) -o "$@" "$<"


fftArduino_data.o : $(START_DIR)/fftArduino_ert_rtw/fftArduino_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
MW_ArduinoHWInit.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../src/MW_ArduinoHWInit.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


io_wrappers.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinobase/src/io_wrappers.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


arduinoAVRScheduler.o : /Users/covasanvictor/Documents/MATLAB/SupportPackages/R2019b/toolbox/target/supportpackages/arduinotarget/registry/../scheduler/src/arduinoAVRScheduler.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
