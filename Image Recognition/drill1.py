...
def getBackground(img):
	...
	for c in cnts:
		...
		for j in cyList:
			if abs(yy-j)<5:
				yFlag = True
		if xFlag==False and yFlag==False and vertices<8 and area>6000 and area<15000 and aspect>0.3 and aspect<0.8 and imgmean>8 and imgmean<30:
			maskFlag = True
			cxList.append(xx)
			cyList.append(yy)
...
def getScrews(img):
	...
	for c in cnts:
		...
		for j in cyList:
			if abs(yy-j)<5:
				yFlag = True
		if xFlag==False and yFlag==False and vertices<8 and area>25 and area<500 and aspect>0.4 and aspect<1.3 and imgmean>25 and imgmean<40:
			cxList.append(xx)
			cyList.append(yy)
